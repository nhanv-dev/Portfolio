                            ...
                            <div className="flex flex-wrap mx-[-30px]">
                                ...
                                <div className="lg:w-[40%] w-full px-[30px]">
                                    ...
                                    <div className="max-w-[300px] w-[max-content]">
                                        ...
                                        <p className="font-[500] text-sm text-gray-300 leading-6">{personalInfo.contact.location}</p>
                                        <h5 className="font-[700] text-[20px] text-primary mt-[20px] mb-[10px]">Email</h5>
                                        <p className="font-[500] text-sm text-gray-300 leading-6">{personalInfo.contact.email}</p>
                                        <h5 className="font-[700] text-[20px] text-primary mt-[20px] mb-[10px]">Phone</h5>
                                        <p className="font-[500] text-sm text-gray-300 leading-6">{personalInfo.contact.phone}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
