                ...
                <div className='flex flex-col lg:flex-row items-center lg:gap-14 mt-10 lg:mt-0'>
                    ...
                    <div className='flex-1 py-10'>
                        <div className="relative w-full overflow-hidden max-h-[400px]">
                            <div className="absolute inset-y-0 left-0 w-[24rem] bg-gradient-to-r from-darkBg to-transparent z-10" />
                            <div className="absolute inset-y-0 right-0 w-[24rem] bg-gradient-to-l from-darkBg to-transparent z-10" />
